...
export const changePassword = (passwordData) => API.patch("/auth/change_password", passwordData);
export const web3Login = (walletData) => API.post("/web3auth/login", walletData);
